...
import { Eye, EyeOff, Mail, Lock, User, UserCheck, Briefcase, Github, Chrome } from 'lucide-react';
...
const SocialLoginPage: React.FC = () => {
  ...
  const onSubmit = async (data: SocialSignUpForm) => {
    setIsLoading(true);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-rose-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 p-8 mb-6">
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <motion.button
                ...
                className="flex items-center justify-center space-x-3 w-full py-4 px-6 border border-gray-300 dark:border-gray-600 rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 disabled:opacity-50"
              >
